...
export const METHOD_ALIASES: Record<string, Record<string, string>> = {
    core: {
        ...
        list: 'getRecentEntries',
        all: 'getRecentEntries',
        latest: 'getRecentEntries',
    ...
    backup: {
        save: 'backupJournal',
        create: 'backupJournal',
        backup: 'backupJournal',
        list: 'listBackups',
