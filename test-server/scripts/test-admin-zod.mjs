...
async function run() {
    ...
    const tests = [
        ...
        {
            name: 'delete_entry (wrong type)',
            tool: 'delete_entry',
            params: { entry_id: 'abc', permanent: false },
        },
        { name: 'merge_tags (empty)', tool: 'merge_tags', params: {} },
        {
            name: 'merge_tags (wrong type)',
            tool: 'merge_tags',
            params: { source_tag: 123, target_tag: 456 },
        },
        { name: 'add_to_vector_index (empty)', tool: 'add_to_vector_index', params: {} },
        {
            name: 'add_to_vector_index (wrong type)',
            tool: 'add_to_vector_index',
            params: { entry_id: 'abc' },
        },
    ]
