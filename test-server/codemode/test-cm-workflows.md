...
- [x] Chaining 2+ API calls in single execution works
- [x] Data transformation (map, flatMap, sort, reduce) works on results
- [x] Conditional branching based on query results works
- [x] Create + read round-trip produces matching data
- [x] Create + search finds the created entry
