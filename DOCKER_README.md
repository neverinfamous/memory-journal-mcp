...
- **Template resources not discoverable**: The 6 template resources (e.g., `memory://kanban/{project_number}`, `memory://issues/{issue_number}/entries`) aren't listed automatically. For full capabilities, refer the agent to the [GitHub README](https://github.com/neverinfamous/memory-journal-mcp) or [Wiki](https://github.com/neverinfamous/memory-journal-mcp/wiki).
