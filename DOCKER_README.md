...
| **Upgraded Session Briefing** | `memory://briefing` delivers capability signals (`readonly`, `team`, `github`), code-map paths, version, test health, unreleased changes, analytics, local Git tree status, and CI workflow outcomes in ~350 tokens |
