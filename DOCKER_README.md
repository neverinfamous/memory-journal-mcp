...
| **Upgraded Session Briefing** | `memory://briefing` delivers capability signals (`readonly`, `team`, `github`), code-map paths, version, test health, unreleased changes, and analytics in ~350 tokens |
