...
|----------|---------|-----------|
| [code-map.md](code-map.md) | Directory tree, handler→tool mapping, error hierarchy, architecture patterns | **First** — before searching the codebase |
| [tool-reference.md](tool-reference.md) | Complete 44-tool inventory by group with parameter descriptions | Need tool names, parameters, or group membership |
