...
![Coverage](https://img.shields.io/badge/Coverage-90.39%25-green.svg)
...
| **Upgraded Session Briefing** | `memory://briefing` delivers capability signals (`readonly`, `team`, `github`), code-map paths, version, test health, unreleased changes, analytics, local Git tree status, and CI workflow outcomes — all in ~350 tokens with 15 configurable flags |
...
**28 Static Resources** (appear in resource lists):
