...
- **Stale File Cleanup** — Removed orphaned PascalCase `src/constants/ServerInstructions.ts` (auto-generated by `npm run generate:instructions` with wrong import path) left over from kebab-case rename migration.
