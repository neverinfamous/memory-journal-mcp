...
### Added
- Bundled native foundational agent skills (`bun`, `github-commander`, `golang`, `mysql`, `postgres`, `rust`, `shadcn-ui`, `skill-builder`, `sqlite`) for out-of-the-box system context
