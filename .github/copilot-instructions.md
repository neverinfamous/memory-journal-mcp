...
Memory Journal MCP is a TypeScript MCP (Model Context Protocol) server providing persistent memory for AI agents. It has **70 tools** across **10 groups** (core, search, analytics, relationships, io, admin, github, backup, team, codemode), **46 resources**, and **18 prompts**.
