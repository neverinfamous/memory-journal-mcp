...
description: React performance optimization guidelines from Vercel Engineering. Use ONLY when explicitly optimizing React performance, Core Web Vitals, or bundle size. NOT for Next.js feature development tasks. NOT for generic caching questions (use next-cache-components). NOT for generic web performance or backend profiling.
license: MIT
metadata:
  author: vercel
  version: '1.0.0'
